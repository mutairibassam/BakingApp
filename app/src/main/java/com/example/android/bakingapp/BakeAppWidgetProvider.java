...
//        views.setTextViewText(R.id.appwidget_text, widgetText);
        ...
        views.setTextViewText(R.id.appwidget_title, sharedPreferences.getString("WIDGET_TITLE", ""));
        views.setTextViewText(R.id.appwidget_list, sharedPreferences.getString("WIDGET_LIST", ""));
